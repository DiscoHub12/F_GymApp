...
class _MyEditDayPage extends State<EditDayPage> {
  final _formKey = GlobalKey<FormState>();
  final TextEditingController _muscoliAllenati = TextEditingController();
  final List<_CompleteExercise> _controllerExercise = [];
  final List<Exercise> _esercizi = [];

  @override
  void initState() {
    super.initState();
    _muscoliAllenati.text = widget.day.muscoliAllenati.toString();
    for (int i = 0; i < widget.day.esercizi.length; i++) {
      print("ESERCIZIO $i : ");
      var completeExercise = _CompleteExercise();
      completeExercise.nomeEsercizio.text =
          widget.day.esercizi[i].nomeEsercizio;
      print("Nome : ${completeExercise.nomeEsercizio.text}");
      completeExercise.reps.text = widget.day.esercizi[i].ripetizioni;
      ...
      completeExercise.width.text =
          widget.day.esercizi[i].peso.toString(); //parsedValue.toString();
        ...
        body: Padding(
            ...
            child: Form(
                ...
                child: Column(
                    ...
                    children: [
                      TextFormField(
                        initialValue: widget.day.muscoliAllenati,
                        controller: _muscoliAllenati,
                        decoration: const InputDecoration(
                          labelText: "Muscles",
                        ),
                      ),
                      ...
                      Expanded(
                          child: ListView.builder(
                              itemCount: widget.day.esercizi.length,
                              itemBuilder: (context, index) {
                                return Row(children: [
                                  Expanded(
                                    child: TextFormField(
                                      initialValue: widget.day.esercizi
                                          .elementAt(index)
                                          .nomeEsercizio,
                                      controller: _controllerExercise
                                          .elementAt(index)
  ...
  void _addExercise() {
    ...
    print("\nIndice controller : ${_controllerExercise.length}");
  }
  ...
  void _saveTwo(BuildContext context) {
    ...
    widget.day.muscoliAllenati = _muscoliAllenati.value.text;
    _controllerExercise.clear();
    _esercizi.clear();
    Navigator.pop(context);
    print("Corretto.");
